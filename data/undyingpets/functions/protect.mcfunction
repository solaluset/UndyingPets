...
execute as @e[tag=!UP.protected] at @s if data entity @s Health if data entity @s Owner if data entity @s HandItems run function undyingpets:protect/register_mob
